...
INSERT INTO category(categoryName) VALUES ('Open back Headphones');
INSERT INTO category(categoryName) VALUES ('Closed back Headphones');
INSERT INTO category(categoryName) VALUES ('Planar IEMs');
INSERT INTO category(categoryName) VALUES ('Bluetooth IEMs');
INSERT INTO category(categoryName) VALUES ('Amps');

INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Sennheiser HD600', 1, 'Classic open back Sennheisers with a neutral tuning',579.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Sennhesier HD800',1,'High end open back Sennheisers',2399.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('HifiMan Sundara',1,'Open back Planar Headphones',469.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Meze Audio 99 Classic',2,'Closed Back Meze headphones',399.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Audio Technica ATH-M50x',2,'Closed Back Audio Technica Headphones',219.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Letshouer S12 Pro',3,'Planar IEMs',228.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('7Hz Timeless ',3,'Planar IEMs',349.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Apple Airpods Pro',4,'Bluetooth IEMs from Apple',329.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Apple Airpods (2nd gen)',4,'Bluetooth IEMs from Apple',179.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Schitt Magni 3',5,'Headphone Power Amp',149.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('FiiO K3',5,'Headphone Power Amp',159.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Sennheiser HE-1',1,'The best headphones out there',79999.00);
